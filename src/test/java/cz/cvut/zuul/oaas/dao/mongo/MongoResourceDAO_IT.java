...
import cz.cvut.zuul.oaas.dao.AbstractResourceDAO_IT;
...
/**
 * Integration tests for {@link cz.cvut.zuul.oaas.dao.mongo.MongoResourceDAO}.
 *
 * @author Jakub Jirutka <jakub@jirutka.cz>
 */
@ActiveProfiles("mongo")
@IfProfileValue(name="it-profile", values={"all", "mongo"})
public class MongoResourceDAO_IT extends AbstractResourceDAO_IT {
